    ...
    return (
        <div className="offcanvas offcanvas-start bg-light" data-bs-scroll="true" tabIndex="-1" id="slider" aria-labelledby="offcanvasExampleLabel">
            <div className="offcanvas-header bg-dark">
                ...
                <h5 className="offcanvas-title session-loged-in fs-3 text-warning" id="offcanvasExampleLabel">{(currentUserId || localStorage.getItem("admin")) ? currentUser : "Guest"}</h5>
            ...
            <div className="offcanvas-body">
                ...
                <ul className="list-unstyled p-2" data-bs-dismiss="offcanvas">
                    ...
                    <li className="list-element" onClick={() => {
                        localStorage.getItem("userId") ? (navigate('/order-page')) : (
                            localStorage.getItem("sellerId") ? (navigate('/seller/orderpage')) : (
                                (navigate('/user/login'), toast.error("Login to See Orders"))
                            ))
                    }}>
                        Orders
                    </li>
                ...
                {localStorage.getItem("admin") && <>
                    <hr />
                    <h6 className="fs-5 fw-bold">Admin</h6>
                    <ul className="list-unstyled p-2" data-bs-dismiss="offcanvas">
                        <li className="list-element" onClick={() => navigate('/admin/user')}>Users</li>
                        <li className="list-element" onClick={() => navigate('/admin/seller')}>Sellers</li>
                    </ul>
                </>}
            </div>
        </div>
